    ...
    class UsuarioController {
        ...
        public function createUsuario() {
            ...
            if (empty($dados['nomeUsuario']))
                return $this->mostrarErro('Você deve informar o nome Usuario!');

            if (empty($dados['cpfUsuario']))
                return $this->mostrarErro('Você deve informar o cfp Usuario!');
        ...
        public function updateUsuario() {
            ...
            if (empty($dados['idUsuario']))
                return $this->mostrarErro('Você deve informar o id Usuario!');

            if (empty($dados['nomeUsuario']))
                return $this->mostrarErro('Você deve informar o nome Usuario!');

            if (empty($dados['cpfUsuario']))
                return $this->mostrarErro('Você deve informar o cpf Usuario!');

            if (empty($dados['senhaUsuario']))
                return $this->mostrarErro('Você deve informar o senha Usuario!');
